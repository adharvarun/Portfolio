...
import { SiJavascript, SiTypescript, SiHtml5, SiPhp, SiAstro, SiSvelte, SiTailwindcss, SiReact, SiSass, SiExpress, SiFastify, SiPrisma, SiAppwrite, SiVuedotjs, SiNodedotjs, SiArduino } from 'react-icons/si';
